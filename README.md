# Text Recognition Site using Cloud Run with Cloud Code

"Text Recognition Site" is a [Cloud Run](https://cloud.google.com/run/docs) application that renders a simple webpage.
